...
**17 MCP tools** covering the full requirements-to-test lifecycle with read+write capabilities across DNG, EWM, and ETM.
...
├── doors_mcp_server.py    # MCP server (17 tools)
